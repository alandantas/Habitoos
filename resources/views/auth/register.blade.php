                    ...
                    <div class="card bg-secondary shadow border-0">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                                <small>Ou cadastre-se na plataforma!</small>
                            </div>
                            <form role="form" action="{{route('register')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" placeholder="Nome" value="{{ old('name') }}"autofocus>
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input id="cpf" type="text" class="form-control{{ $errors->has('cpf') ? ' is-invalid' : '' }}" name="cpf" value="{{ old('cpf') }}" placeholder="Informar CPF, somente números">
                                        @if ($errors->has('cpf'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" placeholder="Confirmar Senha">
                                    </div>
                                </div>
